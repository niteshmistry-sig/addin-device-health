    ...
    function renderNeedAttention() {
        ...
        withIssues.forEach(function (item, i) {
            ...
            html += '<tr data-device-id="' + item.device.id + '" style="cursor:pointer;border-bottom:1px solid #e0e0e0;">' +
                ...
                '<td style="padding:8px 4px;font-size:13px;color:#1976d2;font-weight:500;vertical-align:middle;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">' + escHtml(item.device.name) + '</td>' +
